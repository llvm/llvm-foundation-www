...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9564e2be3df84eedbaec27556955efab0ad6310e23025c9d0008da16c8814c1a.js',function(){input.required=false;search();});}
