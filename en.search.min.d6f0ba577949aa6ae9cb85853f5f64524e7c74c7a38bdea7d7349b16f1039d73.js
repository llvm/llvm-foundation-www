...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3e1e5d2c7a9ba7ba3bf798ddcec4d864bfb4cac4ffc6d2bad521cc8b245081fc.js',function(){input.required=false;search();});}
