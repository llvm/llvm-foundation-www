...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.12d7fc765b6ac6e3ba957e4b13009afc7ea3e80f0286085dfa8a7d90a84f208f.js',function(){input.required=false;search();});}
