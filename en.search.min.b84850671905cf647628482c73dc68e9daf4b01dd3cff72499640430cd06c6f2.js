...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.72a0bb30cd4db3639d0e267e0f7e94779a80a9c11ca184debcce125751ad60ae.js',function(){input.required=false;search();});}
