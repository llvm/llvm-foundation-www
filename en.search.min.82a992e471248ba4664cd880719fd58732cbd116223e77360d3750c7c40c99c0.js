...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.0cf847e5f46c55e9b8069d01db2c59746cee6418ef11c4f83a9d6016ef6e2f51.js',function(){input.required=false;search();});}
