...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.cac5d9e306adfe1bdadac71a54b47d93e3323f902b004517803687f65b5ef38d.js',function(){input.required=false;search();});}
