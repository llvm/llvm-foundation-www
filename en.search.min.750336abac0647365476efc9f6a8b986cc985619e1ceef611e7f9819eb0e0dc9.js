...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c6237f6b81e8a8e3a904dc4faff2f99a11773aefac7330910f498eb40a335bf3.js',function(){input.required=false;search();});}
