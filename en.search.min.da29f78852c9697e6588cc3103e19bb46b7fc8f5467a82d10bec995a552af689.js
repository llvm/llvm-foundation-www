...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c029d86f74ffc9db04a82cabdd6c180f2e7e661950a913f29cc52b72faf888f2.js',function(){input.required=false;search();});}
