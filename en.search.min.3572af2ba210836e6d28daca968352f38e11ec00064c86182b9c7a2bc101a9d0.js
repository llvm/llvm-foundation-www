...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d5c3b13fb2bcc47ab5ba91c4b85e9accd3d26df2a9c5092a61d0df700ce45c7f.js',function(){input.required=false;search();});}
