...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f3afa0e1be529624c850c855d4e7d6a0f0dc17668e37e62e10a2cafab83c936d.js',function(){input.required=false;search();});}
