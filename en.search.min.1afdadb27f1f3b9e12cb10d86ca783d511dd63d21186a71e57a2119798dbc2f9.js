...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.0c1d4defe6e7315d42eacb5d4752eb67a31ea20d6db2677b465e93abe365c4ea.js',function(){input.required=false;search();});}
