...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.51f12ec1ba10eceb3dd71cf3ff02de616575bdf1cdf45948191abf15bd9a01f0.js',function(){input.required=false;search();});}
